...
const fallback:Competition={
  ...
  prize_split_cents:[500000,300000,200000],max_entries:100,entry_count:0,social_tag:"@EDITA",recurs_every_months:2,leaders:[]
};

export default function EditaChallenges(){
  ...
  return <div className="edita-challenges">
    <section className="edita-challenge-hero">
      <div>
    ...
    <section className="edita-prize-grid">
    ...
    <div className="edita-challenge-layout">
      ...
      <section className="card edita-challenge-facts">
        <div className="eyebrow">КАК ВЫБЕРЕМ ПОБЕДИТЕЛЕЙ</div><h3>По подтверждённым просмотрам</h3>
        <p>Побеждают три допустимые работы с самым большим подтверждённым числом просмотров. Команда EDITA проверяет ссылку, открытость публикации, отметку и отсутствие накрутки.</p>
        <dl>
    ...
    <section className="card edita-leaderboard">
