  ...
  try{
    ...
    const r=await fetch("https://api.openai.com/v1/responses",{
      ...
      body:JSON.stringify({
        ...
        instructions:"Ты играешь роль реального клиента видеомонтажёра и одновременно оцениваешь коммуникацию ученика. Клиент должен быть реалистичным, не токсичным. Оценивай: ясность, границы правок, цену, сроки, уточняющие вопросы и профессиональный тон. Пиши по-русски. Не соглашайся автоматически — продолжай переговоры.",
        input:[
          ...conversation,
