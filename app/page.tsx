...
const faq=[
  ...
  ["Можно пользоваться до 18 лет?","Да. Учиться можно сразу. Для денежного конкурса и коммерческой работы понадобится подтверждение взрослого. Название школы скрыто по умолчанию."],
  ...
  return <main className="landing">
    ...
    <section id="challenge" className="challenge-home-band">
      <div className="shell challenge-home-grid">
        ...
        <div className="challenge-prize-card"><div><span>1 место</span><strong>5 000 KP</strong></div><div><span>2 место</span><strong>3 000 KP</strong></div><div><span>3 место</span><strong>2 000 KP</strong></div><p>Бонусные поинты · до 100 участников · понятные правила</p></div>
      </div>
    </section>
