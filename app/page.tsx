  ...
  return <main className="landing">
    ...
    <section id="community-learning" className="section shell">
      ...
      <div className="feature-grid">
        ...
        <article className="feature-card"><h3>Учебные группы</h3><p>Одноклассники или друзья входят по коду и видят общий прогресс. Личного чата с незнакомцами нет.</p></article>
